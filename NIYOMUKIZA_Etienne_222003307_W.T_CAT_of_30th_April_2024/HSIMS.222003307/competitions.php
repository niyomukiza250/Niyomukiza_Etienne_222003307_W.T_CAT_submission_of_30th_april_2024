...
<div>
            <button type="button" onclick="window.location.href='competitionsUpadates.php'">Back</button>
    </div> 
<div class="container">
    <div class="form-container">
        <h2>Add New Competition</h2>
        <form action="competitions.php" method="POST" class="form">
            Competition Title: <input type="text" name="competitionTitle" required><br>
            Date: <input type="date" name="date" required><br>
            Venue: <input type="text" name="venue" required><br>
            <input type="submit" value="Submit">
            <input type="button" value="Cancel" onclick="window.location.href='competitions.php'">
        </form>
    </div>
</div>
<?php
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO Competitions (Competition_title, Date, Venue) VALUES (?, ?, ?)");
    $stmt->bind_param("sss", $competitionTitle, $date, $venue);
