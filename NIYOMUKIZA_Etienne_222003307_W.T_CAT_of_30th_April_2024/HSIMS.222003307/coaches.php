...
<div>
    <button type="button" onclick="window.location.href='coachesRecords.php'">Back</button>
    </div>  
    <div class="form-container">
        <h2>Add New Coach</h2>
        <form action="coaches.php" method="POST" class="form">
            ...
            <input type="button" value="Cancel" onclick="window.location.href='coaches.php'">
        </form>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $stmt = $conn->prepare("INSERT INTO coaches (Name, Specialization, Email, Phone, Address) VALUES (?, ?, ?, ?, ?)");
