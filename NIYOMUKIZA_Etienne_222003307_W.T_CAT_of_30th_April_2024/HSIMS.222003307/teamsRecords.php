...
<main>
    ...
    <div class="container">
        ...
        <a href="teams.php" class="btn btn-success">Add New</a>
    </div>
    <br><br><br>
    <table id="dataTable" class="table table-hover text-center">
        <tr>
            ...
            <th>Team Name</th>
            <th>Coach Name</th>
            <th>Training Facility Location</th>
            <th>Actions</th>
        </tr>
        <?php
        // Database connection
        ...
        $sql = "SELECT t.*, c.Name AS Coach_Name, tf.Location AS Training_Facility_Location
                FROM Teams t
                LEFT JOIN Coaches c ON t.Coach_ID = c.Coach_ID
                LEFT JOIN TrainingFacilities tf ON t.Training_Facility_ID = tf.Facility_ID";
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                echo "<tr>";
                echo "<td>" . $row["Team_ID"] . "</td>"; // Team ID
                echo "<td>" . $row["Team_Name"] . "</td>"; // Team Name
                echo "<td>" . $row["Coach_Name"] . "</td>"; // Coach Name
                echo "<td>" . $row["Training_Facility_Location"] . "</td>"; // Training Facility Location
                echo "<td>";
                // Edit and delete actions
                echo "<a href='edit_team.php?updateID=" . $row["Team_ID"] . "'><i class='fas fa-edit'></i></a>";
                echo "<a href='delete_team.php?deleteID=" . $row["Team_ID"] . "'><i class='fas fa-trash'></i></a>";
                echo "</td>";
                echo "</tr>";
            }
        } else {
