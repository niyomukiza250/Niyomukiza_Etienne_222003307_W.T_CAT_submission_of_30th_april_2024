...
<main>
    ...
    <div class="container">
        ...
        ?>
        <!-- Link to add new competition -->
        <a href="competitions.php" class="btn btn-success">Add New</a>
    </div>
    <br><br><br>
    <table id="dataTable" class="table table-hover text-center">
        ...
        <?php
        // Fetch data from the Competitions table
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<a href='edit_competition.php?updateID=" . $row["Competition_ID"] . "'><i class='fas fa-edit'></i></a>";
                echo "<a href='delete_competition.php?deleteID=" . $row["Competition_ID"] . "'><i class='fas fa-trash'></i></a>";
                echo "</td>";
                echo "</tr>";
            }
        } else {
