...
<body>
<header> 
        <h1><img src="images/icon.png" alt="icon"> Athletes Records</h1>
...
<main>
    ...
    <div class="container">
        ...
        <a href="athletes.php" class="btn btn-success">Add New</a>
    </div>
    <br><br><br>
        <table id="athleteTable" class="table table-hover text-center">
            <tr>
                <th>ID</th>
                <th>Name</th>
                <th>Age</th>
            ...
            <?php
            // Fetch data from the Athletes table
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    // Edit action
                    echo "<a href='edit_athlete.php?updateID=" . $row["Athlete_ID"] . "'><i class='fas fa-edit'></i></a>";
                    // Delete action
                    echo "<a href='delete_athlete.php?deleteID=" . $row["Athlete_ID"] . "'><i class='fas fa-trash'></i></a>";
                    echo "</td>";
                    echo "</tr>";
                }
            } else {
