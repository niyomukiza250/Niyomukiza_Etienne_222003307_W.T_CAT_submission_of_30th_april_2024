...
if (isset($_GET['deleteID'])) {
    ...
    $stmt = $conn->prepare("DELETE FROM TrainingFacilities WHERE Facility_ID=?");
    ...
    try {
        ...
        echo "<script>
                alert('Cannot delete training facility record. Please delete associated records in the referencing table.');
                window.location.href = 'trainingFacilitiesRecords.php';
              </script>";
    }
