...
<head>
    ...
    <title>Training Facilities Management System</title>
...
<main>
    <h2>Training Facilities Records</h2>
    <div class="container">
        <?php
        if(isset($_GET['msg'])){
            $msg = $_GET['msg'];
        ...
        ?>
        <!-- Link to add new training facility -->
        <a href="trainingFacilities.php" class="btn btn-success">Add New</a>
    </div>
    <br><br><br>
    <table id="dataTable" class="table table-hover text-center">
       ...
       require_once "databaseConnection.php";
        ...
        $sql = "SELECT * FROM TrainingFacilities";
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                echo "<tr>";
                echo "<td>" . $row["Facility_ID"] . "</td>"; // Facility ID
                echo "<td>" . $row["Facility_Type"] . "</td>"; // Facility Type
                echo "<td>" . $row["Location"] . "</td>"; // Location
                echo "<td>" . $row["Available_Equipment"] . "</td>"; // Available Equipment
                echo "<td>";
                // Edit and delete actions
                echo "<a href='edit_facility.php?updateID=" . $row["Facility_ID"] . "'><i class='fas fa-edit'></i></a>";
                echo "<a href='delete_facility.php?deleteID=" . $row["Facility_ID"] . "'><i class='fas fa-trash'></i></a>";
                echo "</td>";
                echo "</tr>";
            }
        } else {
